-- Logging module for claude-code.nvim
-- Provides structured logging to ~/.local/state/nvim/claude-code.log
...
-- Log file path
M.log_file = vim.fn.expand("~/.local/state/nvim/claude-code.log")
