-- Picker integration for claude-code.nvim
...
local commands = {
	-- Conversation commands
	{
		...
		action = function()
			require("claude-code.ui").send_current()
		end,
	},
	{
	...
	},
	{
		...
		action = function()
			require("claude-code.ui").new_conversation()
		end,
	},
	{
		...
		action = function()
			require("claude-code.ui").retry_last()
		end,
	},
	-- Window commands
	{
	...
	},
	{
		...
		action = function()
			require("claude-code.ui").toggle_context()
		end,
	},
	{
		...
		action = function()
			require("claude-code.ui").toggle_preview()
		end,
	},
	-- Code actions
	{
